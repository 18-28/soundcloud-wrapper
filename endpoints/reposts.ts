...
export class Reposts extends SoundCloudClient {
  ...
  private async removeRepostRequest(authToken: string, endpoint: string, id: number) {
    try {
      const config = {
        method: "DELETE",
        maxBodyLength: Infinity,
